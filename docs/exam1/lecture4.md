...
-   Python code for this example (with some typical values for `$C_m$` and `$C_f$`) is posted [here](http://nbviewer.jupyter.org/github/ndaman/multiscale/blob/master/examples/Eshelby.ipynb)
